<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
         <el-form-item label="商户名称" prop="agentName">
            <el-input
         ...
         <el-form-item label="支付方式" prop="paywayCode">
            <el-select v-model="queryParams.paywayCode" placeholder="支付方式" clearable style="width: 200px">
               <el-option
                  v-for="dict in dt_payway_code"
                  :key="dict.value"
                  :label="dict.label"
                  :value="dict.value"
               />
         ...
         <el-form-item label="支付场景" prop="sceneCode">
            <el-select v-model="queryParams.sceneCode" placeholder="支付场景" clearable style="width: 200px">
               <el-option
                  v-for="dict in dt_scene_code"
                  :key="dict.value"
                  :label="dict.label"
                  :value="dict.value"
               />
      ...
      <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="商户名称" align="center" prop="merName" />
         <el-table-column label="交易订单号" align="center" prop="orderNo" />
         <el-table-column label="支付方式" align="center" prop="paywayCode" />
         <el-table-column label="支付场景" align="center" prop="sceneCode" />
         <el-table-column label="交易金额" align="center" prop="amount" />
         <el-table-column label="退款金额" align="center" prop="refundAmount" />
         <el-table-column label="商户手续费" align="center" prop="merCharge" />
         <el-table-column label="商户结算金额" align="center" prop="merSettle" />
         <el-table-column label="支付渠道名称" align="center" prop="channelMerName" />
 ...
 import {listMerchantReport} from "@/api/report/report";
 ...
 function getList() {
  loading.value = true;
  listMerchantReport(queryParams.value).then(response => {
