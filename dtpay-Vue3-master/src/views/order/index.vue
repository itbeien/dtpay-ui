   ...
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
         ...
         <el-form-item label="状态" prop="payStatus">
            <el-select v-model="queryParams.payStatus" placeholder="订单状态" clearable style="width: 200px">
               <el-option
      ...
      <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="订单状态" align="center" prop="payStatus">
            <template #default="scope">
               <dict-tag :options="dt_pay_status" :value="scope.row.payStatus" />
            </template>
         </el-table-column>
         ...
         <el-table-column label="操作" width="180" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['dt:order:edit']">修改</el-button>
               <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['dt:order:remove']">删除</el-button>
            </template>
         </el-table-column>
      </el-table>
...
import { listPost, addPost, delPost, getPost, updatePost } from "@/api/order/post";
...
function handleExport() {
  proxy.download("dt/order/export", {
    ...queryParams.value
